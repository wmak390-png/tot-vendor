    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: ListView(padding: const EdgeInsets.all(16), children: [
          ...
          const Center(child: Text('Little Fern Kitchen', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w700))),
          ...
          const _ProfileRow(label: 'Owner', value: 'Aditi Rao'),
          const _ProfileRow(label: 'Phone', value: '+91 98451 22334'),
          const _ProfileRow(label: 'Bank', value: 'HDFC •••• 4281'),
          const SizedBox(height: 16),
